...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Size = System::Drawing::Size(256, 23);
			this->label1->TabIndex = 0;
			this->label1->Text = L"In The Section Number :-\r\n";
			...
			this->label2->Size = System::Drawing::Size(526, 56);
			this->label2->TabIndex = 1;
			this->label2->Text = L"Thank you for your visit . We wish you visit us again \r\n            Enjoy with yo" 
				L"ur selection  book .";
			this->label2->Click += gcnew System::EventHandler(this, &form8::label2_Click);
			// 
			// button1
			// 
			...
			this->button1->Location = System::Drawing::Point(182, 277);
			this->button1->Margin = System::Windows::Forms::Padding(6, 4, 6, 4);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(118, 51);
			...
			this->label3->Text = L"In The Shelf Number :-";
			// 
			// label4
			// 
			...
			this->label5->Location = System::Drawing::Point(15, 77);
			this->label5->Margin = System::Windows::Forms::Padding(6, 0, 6, 0);
			this->label5->Name = L"label5";
			this->label5->Size = System::Drawing::Size(359, 23);
			this->label5->TabIndex = 6;
			this->label5->Text = L"The Book In The Passage Number :-";
			// 
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(372, 74);
			...
			this->textBox2->Size = System::Drawing::Size(55, 31);
			...
			// textBox3
			// 
			this->textBox3->Location = System::Drawing::Point(274, 37);
			this->textBox3->Name = L"textBox3";
			this->textBox3->Size = System::Drawing::Size(48, 31);
			...
			this->ClientSize = System::Drawing::Size(519, 349);
			...
			this->Font = (gcnew System::Drawing::Font(L"Verdana", 14.25F, System::Drawing::FontStyle::Italic, System::Drawing::GraphicsUnit::Point, 
				static_cast<System::Byte>(0)));
			this->ForeColor = System::Drawing::Color::CornflowerBlue;
		//	this->Icon = (cli::safe_cast<System::Drawing::Icon^  >(resources->GetObject(L"$this.Icon")));
			this->Margin = System::Windows::Forms::Padding(6, 4, 6, 4);
			this->Name = L"form8";
			this->Text = L"Book Place Form";
